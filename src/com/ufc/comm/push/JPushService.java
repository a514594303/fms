...
//        testSendPushWithCustomConfig();
      //  testSendIosAlert();
        sendPushWithUser("luhaijia","0001,你有一个新的任务,单号是：0000991199");
	}
	
	public static void sendPushWithUser(String userName, String msg) {

		JPushClient jpushClient = new JPushClient(masterSecret, appKey, 3);

		PushPayload payload = buildPushObject_all_alias_alert("uf_luhaijia", msg);
    ...
    public static PushPayload buildPushObject_all_alias_alert(String registrationId,String alert) {
